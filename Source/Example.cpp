...
const SerialPort = require('serialport');  // Importo la biblioteca serialport, despues instalarla en maquina local
...
float CalculateAcceleration(const TelemVect3& localAccel) {
    // Calcula la magnitud de la aceleración a partir de la aceleración local
